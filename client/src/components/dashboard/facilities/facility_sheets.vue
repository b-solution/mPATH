...
<script>
  ...
  import DetailSheet from './detail_sheet.vue'
  import NotesSheetsIndex from './../notes/notes_sheets_index.vue'
  import IssueSheetsIndex from './../issues/issue_sheets_index.vue'
  import TaskSheetsIndex from './../tasks/task_sheets_index.vue'
  import RiskSheetsIndex from './../risks/sheets/risk_sheets_index.vue'
