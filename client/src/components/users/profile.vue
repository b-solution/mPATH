<template>
  <div id="users_wrapper" v-if="!loading">
    ...
    <form @submit.prevent="handleSubmit" class="w-100" autocomplete="off">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="text" name="firstName" v-validate="'required'" class="form-control" v-model="profile.firstName"
            placeholder="John" :class="{ 'error': errors.has('firstName') }">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="text" name="lastName" v-validate="'required'" class="form-control" v-model="profile.lastName"
            placeholder="John" :class="{ 'error': errors.has('lastName') }">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="email" readOnly class="form-control" v-model="profile.email" placeholder="johndoe@example.com"
            autocomplete="off" required>
        </div>
      </div>
      <div class="form-group row">
        <label class="col-sm-2 col-form-label">Password <span class="font-sm text-success"
            @click.prevent.stop="editPass = true">(click to edit)</span></label>
        <div class="col-sm-10">
          <input type="password" class="form-control" placeholder="Password" v-model="profile.password"
            :readOnly="!editPass" autocomplete="off">
          <div class="ml-1">
            <div v-if="C_passValidationCheck.length" class="font-sm text-danger">{{ C_passValidationCheck.length }}</div>
            <div v-if="C_passValidationCheck.uppercase" class="font-sm text-danger">{{ C_passValidationCheck.uppercase }}
            </div>
            <div v-if="C_passValidationCheck.smallcase" class="font-sm text-danger">{{ C_passValidationCheck.smallcase }}
            </div>
            <div v-if="C_passValidationCheck.digits" class="font-sm text-danger">{{ C_passValidationCheck.digits }}</div>
            <div v-if="C_passValidationCheck.specialcase" class="font-sm text-danger">
              {{ C_passValidationCheck.specialcase }}</div>
          </div>
        </div>
      </div>
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="password" :readOnly="!editPass" class="form-control" placeholder="Password Confirm"
            v-model="profile.passwordConfirmation" autocomplete="off">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <vue-phone-number-input :value="C_phone" @update="onUpdatePhone" id="phone-number__input"
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <GmapAutocomplete class='gmap-input form-control' @place_changed="updateAddress" :value="profile.address"
            @input.stop="profile.address.address = $event.target.value" @keypress.enter="$event.preventDefault" />
          <div v-if="C_addressDrawn" class='gmap-wraper'>
            <GmapMap map-type-id="terrain" ref="googlemap" :zoom="15" :options="{
    rotateControl: false,
    minZoom: 2,
    zoomControl: true,
    ...
    fullscreenControl: false
  }" style="width: 100%; height: 99%" :center="center">
              <GmapMarker :animation="4" :position="C_latLng" />
            </GmapMap>
          </div>
        </div>
      </div>
      ...
      <div class="form-group row" v-if='false'>
        ...
        <div class="col-sm-10">
          <el-select v-model="selectedProgram" class="w-100" track-by="id" value-key="id" clearable filterable
            placeholder="Search and select Program">
            <el-option v-for="item in programOptions" :value="item" :key="item.id" :label="item.name">
            </el-option>
          </el-select>
        </div>
      </div>
      ...
      <div class="form-group row" v-if='false'>
        ...
        <div class="col-sm-10">
          <el-select v-model="selectedProjectGroup" class="w-100" track-by="id" value-key="id" clearable filterable
            placeholder="Search and select Group" :disabled="!this.selectedProgram">
            <el-option v-for="item in projectGroupOptions" :value="item" :key="item.id" :label="item.name">
            </el-option>
          </el-select>
        </div>
      </div>
      ...
      <div class="form-group row" v-if='false'>
        ...
        <div class="col-sm-10">
          <el-select v-model="selectedProject" class="w-100" track-by="id" value-key="id" clearable filterable
            placeholder="Search and select Project" :disabled="!this.selectedProjectGroup">
            <el-option v-for="item in projectOptions" :value="item" :key="item.id" :label="item.name">
            </el-option>
          </el-select>
        </div>
      </div>
      ...
      <div class="form-group row" v-if='false'>
        ...
        <div class="col-sm-10">
          <el-select v-model="selectedNavigation" class="w-100" track-by="id" value-key="id" clearable filterable
            placeholder="Search and select Navigation" :disabled="!this.selectedProject"
            @change="navigationSelectChange">
            <el-option v-for="item in navigationOptions" :value="item" :key="item.id" :label="item.name">
            </el-option>
          </el-select>
        </div>
      </div>
      ...
      <div class="form-group row" v-if='false'>
        ...
        <div class="col-sm-10">
          <el-select v-model="selectedSubNavigation" class="w-100" track-by="id" value-key="id" clearable filterable
            placeholder="Search and select Sub Navigation"
            :disabled="!this.selectedProject || !this.selectedNavigation">
            <el-option v-for="item in subNavigationOptions" :value="item" :key="item.id" :label="item.name">
            </el-option>
          </el-select>
        </div>
      </div>
