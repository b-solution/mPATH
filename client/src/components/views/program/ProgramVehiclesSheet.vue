...
<template>
  <div class="my-1 pb-2 buttonWrapper container-fluid">
    <div class="row px-0 mb-2">
      <div class="col">
        <el-input type="search" placeholder="Search Vehicles" aria-label="Search" aria-describedby="search-addon"
          v-model="search" data-cy="">
          <el-button slot="prepend" icon="el-icon-search"></el-button>
        </el-input>
      </div>
      <div class="col pl-0">
        <el-select class="w-100 mx-2" v-model="C_projectGroupFilter" track-by="id" value-key="id" multiple filterable
          clearable name="Project Group" placeholder="Filter Vehicles By Group">
          <el-option v-for="item in facilityGroups" :key="item.id" :label="item.name" :value="item">
          </el-option>
        </el-select>
      </div>
    </div>
    <div v-if="tableData" v-loading="!contentLoaded" element-loading-text="Fetching your data. Please wait..."
      ...
      <el-table :data="tableData
        ...
        <el-table-column prop="subprimeName" sortable width="200" label="Vehicle Prime">
        ...
        <el-table-column prop="name" sortable width="200" label="Vehicle Nickname">
        </el-table-column>
        ...
        <el-table-column label="Contract Agency" prop="contractAgencyId">
          <template slot-scope="scope">
            <span v-if="scope.row.contractAgency &&
        ...
        <el-table-column label="Vehicle Type" prop="contractVehicleTypeId">
          <template slot-scope="scope">
            <span v-if="scope.row.contractVehicleType &&
        ...
        <el-table-column label="Actions" width="300">
          <template slot-scope="scope">
            <el-button v-tooltip="`Go to Vehicle`" type="default" @click.prevent="goToVehicle(scope.$index, scope.row)"
              class="bg-light">
