      ...
      <span class="float-right">
        <router-link :to="goBack">
          <button class="portfolioHomeBtn mh-orange btn btn-sm" style="cursor: pointer" @click="resetFlags">
            <i class="fas fa-arrow-alt-circle-left text-light"></i>
            <!-- <i class="fas fa-arrow-alt-left text-light"></i> -->
          </button>
        </router-link>
      </span>
    </div>
    <div class="container-fluid mx-3 portfolioView_main" v-loading="!contentLoaded"
      element-loading-text="Fetching Program Viewer data. Please wait..." :class="[!contentLoaded ? 'vh100' : '']"
      ...
      <el-tabs class="mt-1 mr-3" type="border-card">
        <el-tab-pane class="p-3" style="postion:relative">
          ...
          <el-dialog :visible.sync="dialogVisible" append-to-body center class="portfolioDialogMode">
            <template slot="title">
              <div v-if="dynamicObj.length > 0 && dynamicObj[currentTaskSlide] !== undefined" class="container-fluid">
                <h5 class="pl-2 mt-3 d-inline-block px-3 mh-blue text-light"
                ...
                <div v-for="number in [currentTaskSlide]" :key="number">
                  <div class="row justify-content-center">
                    ...
                    <div class="col-5 text-center px-3 py-2" v-if="dynamicObj[currentTaskSlide]">
                      ...
                      <span v-if="dynamicObj[currentTaskSlide] && dynamicObj[currentTaskSlide].isOverdue"
                        v-tooltip="`Overdue`">
                        <i class="fas fa-calendar text-danger mr-1" style="font-size:1.8rem"></i></span>
                      <span v-if="dynamicObj[currentTaskSlide] && dynamicObj[currentTaskSlide].completed"
                      ...
                      <span
                        ...
                        v-tooltip="`Ongoing`"><i class="fas fa-retweet mr-1 text-success"
                          style="font-size:1.8rem"></i></span>
                      <span v-if="dynamicObj[currentTaskSlide] && dynamicObj[currentTaskSlide].closed"
                        v-tooltip="`Ongoing: Closed`"><i class="fas fa-retweet mr-1 text-secondary"
                          style="font-size:1.8rem"></i></span>

                      <span v-if="dynamicObj[currentTaskSlide] && dynamicObj[currentTaskSlide].onHold == true"
                        v-tooltip="`On Hold`">
                        <i class="fas fa-pause-circle mr-1 text-primary" style="font-size:1.8rem"></i></span>
                      <span v-if="dynamicObj[currentTaskSlide] && dynamicObj[currentTaskSlide].draft == true"
                        v-tooltip="`Draft`">
                        <i class="fas fa-pencil-alt mr-1 text-warning" style="font-size:1.8rem"></i></span>
                      <span v-if="dynamicObj[currentTaskSlide] && dynamicObj[currentTaskSlide].planned"
                        v-tooltip="`Planned`">
                        <i class="fas fa-calendar-check text-info mr-1" style="font-size:1.8rem"></i></span>
                      <span v-if="dynamicObj[currentTaskSlide] && dynamicObj[currentTaskSlide].inProgress"
                    ...
                    <div class="col-3 mt-3">
                      <img style="width: 145px" :src="require('../../../assets/images/microhealthllc.png')" />
                    </div>
                  </div>
                  ...
                  <div class="row pt-3 justify-content-center">
                    ...
                    <div class="col-3 text-center slideCol leftProgramCol">
                      ...
                      <div class="col py-2">
                        ...
                        <h4 v-if="dynamicObj[currentTaskSlide] && dynamicObj[currentTaskSlide].programName">
                          {{ dynamicObj[currentTaskSlide].programName }}</h4>
                      </div>

                      <div class="col truncate-line-two">
                        <h6 class="leftColLabel text-light mh-orange">GROUP</h6>
                        <h4 v-if="dynamicObj[currentTaskSlide] && dynamicObj[currentTaskSlide].projectGroup">
                          {{ dynamicObj[currentTaskSlide].projectGroup }} </h4>
                      ...
                      <div class="col py-2">
                        <span v-if="dynamicObj[currentTaskSlide] && dynamicObj[currentTaskSlide].projectContractId">
                          ...
                          <h4 v-if="dynamicObj[currentTaskSlide] && dynamicObj[currentTaskSlide].contractNickname">{{
          dynamicObj[currentTaskSlide].contractNickname }} </h4>
                        </span>
                        <span
                          v-if="dynamicObj[currentTaskSlide] && dynamicObj[currentTaskSlide].projectContractVehicleId">
                          <h6 class="leftColLabel text-light mh-orange">VEHICLE</h6>
                          <h4 v-if="dynamicObj[currentTaskSlide] && dynamicObj[currentTaskSlide].vehicleNickname">{{
          dynamicObj[currentTaskSlide].vehicleNickname }} </h4>
                        </span>
                        <span v-else>
                          <h6 class="leftColLabel text-light mh-orange">PROJECT</h6>
                          <h4 v-if="dynamicObj[currentTaskSlide] && dynamicObj[currentTaskSlide].facilityName">{{
          dynamicObj[currentTaskSlide].facilityName }} </h4>
                        </span>
                      ...
                      <div class="col">
                        ...
                        <h4 v-if="dynamicObj[currentTaskSlide] && dynamicObj[currentTaskSlide].taskType">{{
          dynamicObj[currentTaskSlide].taskType }} </h4>
                        <h4 v-else> -- </h4>
                      </div>
          ...
          dynamicObj[currentTaskSlide].lastUpdate.user.fullName
                    ...
                    <div class="col-3 mh-blue text-center text-light slideCol"
                      ...
                      <div class="col pt-2">
                        ...
                        <span v-if="dynamicObj[currentTaskSlide] && dynamicObj[currentTaskSlide].startDate"
                          class="d-inline-block">
                          <h5>{{ moment(dynamicObj[currentTaskSlide].startDate).format("DD MMM YYYY") }}</h5>
                        </span>
                        <span v-else> -- </span>
                        -
                        <span v-if="dynamicObj[currentTaskSlide] && dynamicObj[currentTaskSlide].dueDate"
                          class="d-inline-block">
                          <h5> {{ moment(dynamicObj[currentTaskSlide].dueDate).format("DD MMM YYYY") }}</h5>
                        </span>
                        <span v-else> </span>
                      ...
                      <div class="col mt-3 truncate-line-two">
                        ...
                        <span class="truncate-line-two" v-if="dynamicObj[currentTaskSlide].users.length > 0">
                          <h4> {{ dynamicObj[currentTaskSlide].userNames }}</h4>
                        </span>
                        <span v-else>
                      ...
                      <div class="col" v-if="!dynamicObj[currentTaskSlide].ongoing">
                        ...
                        <span :class="{ 'text-light': dynamicObj[currentTaskSlide].progress <= 0 }">
                          <el-progress type="circle" class="py-2 text-light"
                            :percentage="Math.round(dynamicObj[currentTaskSlide].progress)"></el-progress>
                        </span>
              ...
              <div slot="footer" class="dialog-footer">
                <el-button class="mh-orange elBtn text-light" @click.prevent="previousTask"><i
                    class="far fa-chevron-left" style="font-size:1.35rem"></i></el-button>
                <el-button class="bg-secondary elBtn text-light"><span style="font-size:1.35rem"><span>{{ action
                      }}</span> {{ currentTaskSlide + 1 }} of {{ dynamicObj.length }}</span></el-button>
          ...
          <div class="row pb-4" v-if="contentLoaded" :load="log(currentProject)">
            <div class="col-3 py-2">
              ...
              <div class="w-100">
                ...
                <el-button-group
                  v-if="currentProject && currentProject.contracts && currentProject.contracts.length > 0">
                  <el-button :class="[getShowProjectStats == 0 ? 'lightBtn' : 'inactive']"
                    @click.prevent="showProjectStats" class="p-2 ">
                    <i class="fal fa-clipboard-list mr-1"
                      :class="[getShowProjectStats == 0 ? 'mh-green-text' : 'inactive']"></i>
                    PROJECTS
                    <span v-if="currentProject && currentProject.facilities"
                      class="ml-1 badge badge-secondary badge-pill pill">{{
          currentProject.facilities.length }}
                    </span>
                  </el-button>
                  <el-button :class="[getShowProjectStats == 1 ? 'lightBtn' : 'inactive']"
                    @click.prevent="showContractStats" class="p-2 ">
                    <i class="far fa-file-contract mr-1"
                      :class="[getShowProjectStats == 1 ? 'mh-orange-text' : 'inactive']"></i>
                    CONTRACTS
                    <span v-if="currentProject && currentProject.contracts"
                      class="ml-1 badge badge-secondary badge-pill pill">{{
          currentProject.contracts.length }}
                    </span>
                  </el-button>
                  <el-button :class="[getShowProjectStats == 2 ? 'lightBtn' : 'inactive']"
                    @click.prevent="showVehicleStats" class="p-2 ">
                    <i class="far fa-car mr-1" :class="[getShowProjectStats == 2 ? 'text-info' : 'inactive']"></i>
                    VEHICLES
                    <span v-if="currentProject && currentProject.contractVehicles"
                      class="ml-1 badge badge-secondary badge-pill pill">{{ currentProject.contractVehicles.length }}
                    </span>
                  </el-button>
                </el-button-group>
              </div>
            ...
            <div class="col-3 py-2">
              <div class="w-100">
                ...
                <div class="w-100" v-if="currentTab == '#tab-issues'">
                  <el-input type="search" placeholder="Enter Issues Search Criteria" v-model="issuesQuery">
                    <el-button slot="prepend" icon="el-icon-search"></el-button>
                  </el-input>
                </div>
                <div class="w-100" v-if="currentTab == '#tab-risks'">
                  <el-input type="search" placeholder="Enter Risks Search Criteria" v-model="risksQuery">
                    <el-button slot="prepend" icon="el-icon-search"></el-button>
                  </el-input>
                </div>
                <div class="w-100" v-if="currentTab == '#tab-lessons'">
                  <el-input type="search" placeholder="Enter Lessons Search Criteria" v-model="lessonsQuery">
                    <el-button slot="prepend" icon="el-icon-search"></el-button>
                  </el-input>
                </div>
              ...
              <div class="w-100">
                ...
                <template>
                  <!-- <treeselect  
                    ...
                    valueFormat="object"
                    />       -->
                  <treeselect placeholder="Search and select" :multiple="true" :options="programProjectGroups"
                    :value="C_projectGroupsFilter" v-model="C_projectGroupsFilter" track-by="name" :limit="3"
                    :maxHeight="200" :limitText="count => `...`" valueFormat="object" />
            ...
            <div class="col-3 pl-0 py-2">
              <div class="w-100 pr-3">
                ...
                <template>
                  <el-select v-model="C_programCategoryFilter" class="w-100" track-by="name" value-key="id" multiple
                    clearable placeholder="Select Process Area">
                    <el-option v-for="item in taskTypes" :value="item" :key="item.id" :label="item.name">
                      <!-- <el-option
                  ...
                  <div class="col-10 px-1 pt-2">
                    ...
                    <div class="pb-0 pl-2 pr-4 mb-0 d-inline-flex">
                      ...
                      <span class="d-flex statesCol mr-3 px-3 py-2">
                        <div class="pr-4 text-center icons" :class="[getHideComplete == true ? 'light' : '']"
          ...
          getShowCount == false ? 'd-none' : 'd-block',
                        ...
                        <div class="pr-4 text-center icons" :class="[getHideInprogress == true ? 'light' : '']"
          ...
          getShowCount == false ? 'd-none' : 'd-block',
                        ...
                        <div class="pr-4 text-center icons" :class="[getHideOverdue == true ? 'light' : '']"
          ...
          getShowCount == false ? 'd-none' : 'd-block',
                        ...
                        <div class="pr-4 text-center icons" :class="[getHideOngoing == true ? 'light' : '']"
          ...
          taskVariation.ongoingClosed.count
                        ...
                        <div class="pr-4 text-center icons" :class="[getHidePlanned == true ? 'light' : '']"
          ...
          taskVariation.planned.count
                        ...
                        <div class="pr-4 text-center icons" :class="[getHideOnhold == true ? 'light' : '']"
          ...
          getShowCount == false ? 'd-none' : 'd-block',
                        ...
                        <div class="text-center icons" :class="[getHideDraft == true ? 'light' : '']"
          ...
          getShowCount == false ? 'd-none' : 'd-block',
                      ...
                      <span class="tagsCol d-flex px-3 py-2">
                        <div class="text-center icons" :class="[getHideWatched == true ? '' : 'light']"
          ...
          getShowCount == false ? 'd-none' : 'd-block',
                        ...
                        <div class="px-4 text-center icons" :class="[getHideImportant == true ? '' : 'light']"
          ...
          getShowCount == false ? 'd-none' : 'd-block',
                        ...
                        <div class="text-center icons" :class="[getHideBriefed == true ? '' : 'light']"
                  ...
                  <div class="col-2 pl-0 pr-2">
                    <span class="btnRow d-flex">
                      ...
                      <button v-tooltip="`Export to PDF`" @click.prevent="exportTasksToPdf"
                        class="btn btn-md exportBtns text-light" :disabled="filteredTasks.filtered.tasks.length == 0">
          ...
          " class="btn btn-md mx-1 exportBtns text-light"
                ...
                <div class="row mt-3 pr-3" style="postion:relative" v-if="filteredTasks.filtered.tasks.length > 0">

                  <div class="px-3 tableFixHead">
                    <table class="table table-sm table-bordered" ref="table" id="portTasks">
                      <thead style="background-color: #ededed">
                        <th class="pl-1 sort-th twenty" @click="sortCol1('projectGroup')">
                          Group
                          <span class="inactive-sort-icon scroll" v-if="currentSortCol1 !== 'projectGroup'">
                            <i class="fas fa-sort"></i></span>
                          <span class="sort-icon main scroll" v-if="currentSortDir1 === 'asc' && currentSortCol1 === 'projectGroup'
          ">
                            <i class="fas fa-sort-up"></i></span>
                          <span class="inactive-sort-icon scroll" v-if="currentSortDir1 !== 'asc' && currentSortCol1 === 'projectGroup'
          ">
                            <i class="fas fa-sort-up"></i></span>
                          <span class="sort-icon main scroll" v-if="currentSortDir1 === 'desc' && currentSortCol1 === 'projectGroup'
          ">
                            <i class="fas fa-sort-down"></i></span>
                          <span class="inactive-sort-icon scroll" v-if="currentSortDir1 !== 'desc' && currentSortCol1 === 'projectGroup'
          ">
                            <i class="fas fa-sort-down"></i></span>
                        </th>
                        <th v-if="getShowProjectStats == 0" class="pl-1 sort-th twenty"
                          @click="sortCol2('facilityName')">
                          Project Name
                          <span class="inactive-sort-icon scroll" v-if="currentSortCol2 !== 'facilityName'">
                            <i class="fas fa-sort"></i></span>
                          <span class="sort-icon main scroll" v-if="currentSortDir2 === 'asc' && currentSortCol2 === 'facilityName'
          ">
                            <i class="fas fa-sort-up"></i></span>
                          <span class="inactive-sort-icon scroll" v-if="currentSortDir2 !== 'asc' && currentSortCol2 === 'facilityName'
          ">
                            <i class="fas fa-sort-up"></i></span>
                          <span class="sort-icon main scroll" v-if="currentSortDir2 === 'desc' && currentSortCol2 === 'facilityName'
          ">
                            <i class="fas fa-sort-down"></i></span>
                          <span class="inactive-sort-icon scroll" v-if="currentSortDir2 !== 'desc' && currentSortCol2 === 'facilityName'
          ">
                            <i class="fas fa-sort-down"></i></span>
                        </th>
                        <th v-if="getShowProjectStats == 1" class="pl-1 sort-th twenty"
                          @click="sortCol2('contractNickname')">
                          Contract Name
                          <span class="inactive-sort-icon scroll" v-if="currentSortCol2 !== 'contractNickname'">
                            <i class="fas fa-sort"></i></span>
                          <span class="sort-icon main scroll" v-if="currentSortDir2 === 'asc' && currentSortCol2 === 'contractNickname'
          ">
                            <i class="fas fa-sort-up"></i></span>
                          <span class="inactive-sort-icon scroll" v-if="currentSortDir2 !== 'asc' && currentSortCol2 === 'contractNickname'
          ">
                            <i class="fas fa-sort-up"></i></span>
                          <span class="sort-icon main scroll" v-if="currentSortDir2 === 'desc' && currentSortCol2 === 'contractNickname'
          ">
                            <i class="fas fa-sort-down"></i></span>
                          <span class="inactive-sort-icon scroll" v-if="currentSortDir2 !== 'desc' && currentSortCol2 === 'contractNickname'
          ">
                            <i class="fas fa-sort-down"></i></span>
                        </th>
                        <th v-if="getShowProjectStats == 2" class="pl-1 sort-th twenty" @click="sortCol2('name')">
                          Nickname
                          <span class="inactive-sort-icon scroll" v-if="currentSortCol2 !== 'name'">
                            <i class="fas fa-sort"></i></span>
                          <span class="sort-icon main scroll" v-if="currentSortDir2 === 'asc' && currentSortCol2 === 'name'
          ">
                            <i class="fas fa-sort-up"></i></span>
                          <span class="inactive-sort-icon scroll" v-if="currentSortDir2 !== 'asc' && currentSortCol2 === 'name'
          ">
                            <i class="fas fa-sort-up"></i></span>
                          <span class="sort-icon main scroll" v-if="currentSortDir2 === 'desc' && currentSortCol2 === 'name'
          ">
                            <i class="fas fa-sort-down"></i></span>
                          <span class="inactive-sort-icon scroll" v-if="currentSortDir2 !== 'desc' && currentSortCol2 === 'name'
          ">
                            <i class="fas fa-sort-down"></i></span>
                        </th>
          ...
          ">
                        ...
                        <th class="sort-th twenty" @click="sort('notesUpdatedAt')" style="min-width: 300px">
                          Last Update
          ...
          ">
                        ...
                        <th class="sort-th" style="min-width: 140px" @click="sort('startDate')">
                          Start Date
          ...
          ">
                        ...
                        <th class="sort-th" style="min-width: 140px" @click="sort('dueDate')">
                          Due Date
          ...
          ">
                      ...
                      <tbody>
                        <tr v-for="(task, index) in sortedTasks" :key="index" class="portTable taskHover"
                          @click="openTask(task)">
          ...
          moment(task.startDate).format("DD MMM YYYY")
                          ...
                          <td class="text-center">
                            ...
                            <span
                              v-else-if="task.completed && (task.dueDate == null || task.dueDate == undefined)"></span>
                            <span v-else-if="task.onHold && task.dueDate == null"
          ...
          moment(task.dueDate).format("DD MMM YYYY")
                          ...
                          <td class="text-center">
                            ...
                            <span v-if="task.onHold == true" v-tooltip="`On Hold`">
                            ...
                            <span v-if="task.inProgress" v-tooltip="`In Progress`">
                    ...
                    <table class="table table-bordered w-100" id="portTasks1" style="display:none">
                      <thead>
                      ...
                      <tbody v-for="(p, i) in validTaskProjectGroups" :key="i">
                        ...
                        <tr v-for="(task, index) in filteredTasks.filtered.tasks" :key="index"
                          v-if="task.projectGroup == p">
                          <td>{{ task.text }}</td>
                          <td>{{ task.taskType }}</td>
                  ...
                  <div class="ml-auto mb-4 mt-2 font-sm">
                    <div class="simple-select d-inline-block text-right font-sm">
                      ...
                      <el-select v-model="C_tasksPerPage" class="w-33" track-by="value" value-key="id">
                        <el-option v-for="item in getTasksPerPageOptions" :value="item" :key="item.id"
                          :label="item.name">
                        </el-option>
                      </el-select>
                    </div>
