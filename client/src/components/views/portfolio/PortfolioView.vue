<template>
  <div class="container-fluid mt-3 mx-3 portfolioView_main" v-loading="!portfolioProgramsLoaded"
    element-loading-text="Fetching Portfolio data. Please wait..." element-loading-spinner="el-icon-loading"
    element-loading-background="rgba(0, 0, 0, 0.8)" :class="{ vh100: !portfolioProgramsLoaded }">
    <!-- Actual Portfolio name will be dynamic value of organization name   -->
    <div>
      <span @click.prevent="backHomeBtn">
        <img class="mb-2" style="width: 147px;cursor:pointer" src="microhealthllc.png" />
    ...
    <el-tabs class="mt-2 mr-3" type="border-card">
      <el-tab-pane label="PORTFOLIO DATA VIEWER" class="p-3" style="postion:relative">
        ...
        <el-dialog :visible.sync="dialogVisible" append-to-body center class="portfolioDialogMode">
          <template slot="title">
            <div v-if="dynamicObj.length > 0 &&
      dynamicObj[currentTaskSlide] !== undefined
      " class="container-fluid">
              <h5 class="pl-2 mt-3 d-inline-block mh-blue px-3 text-light"
              ...
              <div v-for="number in [currentTaskSlide]" :key="number">
                <div class="row justify-content-center">
                  <div class="col-3 pb-0">
                    <img class="mb-0" style="width: 125px" :src="require('../../../assets/images/mpath.png')" />
                  </div>
                  <div class="col-5 text-center px-3 py-2" v-if="dynamicObj[currentTaskSlide]">
                    <span v-if="dynamicObj[currentTaskSlide] &&
      dynamicObj[currentTaskSlide].is_overdue
      " v-tooltip="`Overdue`">
                      <i class="fas fa-calendar text-danger mr-1" style="font-size:1.8rem"></i></span>
                    <span v-if="dynamicObj[currentTaskSlide] &&
      dynamicObj[currentTaskSlide].completed
      " v-tooltip="`Completed`"><i class="fas fa-clipboard-check text-success mr-1"
                        style="font-size:1.8rem"></i></span>
                    <span v-if="dynamicObj[currentTaskSlide] &&
      dynamicObj[currentTaskSlide].ongoing == true &&
      dynamicObj[currentTaskSlide].closed == false
      " v-tooltip="`Ongoing`"><i class="fas fa-retweet mr-1 text-success" style="font-size:1.8rem"></i></span>
                    <span v-if="dynamicObj[currentTaskSlide] &&
      dynamicObj[currentTaskSlide].closed
      " v-tooltip="`Ongoing: Closed`"><i class="fas fa-retweet mr-1 text-secondary"
                        style="font-size:1.8rem"></i></span>
                    <span v-if="dynamicObj[currentTaskSlide] &&
      ...
      " v-tooltip="`On Hold`">
                      <i class="fas fa-pause-circle mr-1 text-primary" style="font-size:1.8rem"></i></span>
                    <span v-if="dynamicObj[currentTaskSlide] &&
      dynamicObj[currentTaskSlide].draft == true
      " v-tooltip="`Draft`">
                      <i class="fas fa-pencil-alt mr-1 text-warning" style="font-size:1.8rem"></i></span>
                    <span v-if="dynamicObj[currentTaskSlide] &&
      dynamicObj[currentTaskSlide].planned
      " v-tooltip="`Planned`">
                      <i class="fas fa-calendar-check text-info mr-1" style="font-size:1.8rem"></i></span>
                    <span v-if="dynamicObj[currentTaskSlide] &&
      dynamicObj[currentTaskSlide].in_progress
      " v-tooltip="`In Progress`">
                      <i class="far fa-tasks text-primary mr-1" style="font-size:1.8rem"></i></span>
                  ...
                  <div class="col-3 mt-3">
                    <img style="width: 145px" :src="require('../../../assets/images/mpath.png')
      " />
                  </div>
                </div>
                ...
                <div class="row pt-3 justify-content-center">
                  <div class="col-3 text-center slideCol leftProgramCol">
                    <div class="col py-2">
                      ...
                      <h4 v-if="dynamicObj[currentTaskSlide] &&
                  ...
                  <div class="col-5 text-center  mx-4 p-0" v-if="dynamicObj[currentTaskSlide] !== undefined">
                    <div class="lastUpdateCol">
                      ...
                      <div style="height:300px; overflow-y:auto">
                        <span v-if="dynamicObj[currentTaskSlide].notes_updated_at
      .length > 0
      ">
                          <span>
                            <br />
      ...
      moment(dynamicObj[currentTaskSlide].date).format(
        "DD MMM YYYY"
                    ...
                    <div class="col mt-3 truncate-line-two" v-if="dynamicObj == lessonsObj.filtered.lessons">
                      ...
                      <span class="truncate-line-two" v-if="dynamicObj[currentTaskSlide].added_by">
                        <h4>
                    ...
                    <div class="col mt-3 truncate-line-two" v-if="dynamicObj !== lessonsObj.filtered.lessons">
                      ...
                      <span class="truncate-line-two" v-if="dynamicObj[currentTaskSlide].users.length > 0">
                        <h4>{{ dynamicObj[currentTaskSlide].users }}</h4>
                      </span>
                      <span v-else>
                    ...
                    <div class="col" v-if="dynamicObj !== lessonsObj.filtered.lessons &&
      ...
      'text-light':
        dynamicObj[currentTaskSlide].progress <= 0,
                        ...
                        <el-progress type="circle" class="py-2 text-light" :percentage="Math.round(dynamicObj[currentTaskSlide].progress)
      "></el-progress>
                      </span>
      ...
      dynamicObj[currentTaskSlide].risk_approach.slice(1)
                      ...
                      <h4 v-if="dynamicObj[currentTaskSlide].priority_level ==
      'Very Low'
      " class="gray2 px-1 riskLabels">
                        Very Low
                      </h4>
                      <h4 v-else-if="dynamicObj[currentTaskSlide].priority_level == 'Low'
      " class="green1 riskLabels px-1">
                        Low
                      </h4>
                      <h4 v-else-if="dynamicObj[currentTaskSlide].priority_level ==
      'Moderate'
      " class="yellow1 riskLabels px-1">
                        Moderate
                      </h4>
                      <h4 v-else-if="dynamicObj[currentTaskSlide].priority_level == 'High'
      ...
      " class="red1 riskLabels px-1">
            ...
            <div slot="footer" class="dialog-footer-left" v-if="dynamicObj[currentTaskSlide] !== undefined">
              <el-button class="elBtn tagsBtn py-1 text-light mr-2">
                ...
                <span v-if="dynamicObj[currentTaskSlide].watched == true" v-tooltip="`On Watch`"><i
                    class="fas fa-eye mr-1 text-dark" style="font-size:1.5rem"></i></span>
                <span v-if="dynamicObj[currentTaskSlide].important == true" v-tooltip="`Important`">
                  <i class="fas fa-star text-warning mr-1 " style="font-size:1.5rem"></i></span>
                <span v-if="dynamicObj[currentTaskSlide].reportable" v-tooltip="`Briefings`">
                  <i class="fas fa-presentation mr-1 text-primary" style="font-size:1.5rem"></i></span>
              </el-button>
            </div>

            <div slot="footer" class="dialog-footer">
              <el-button class="mh-orange elBtn text-light" @click.prevent="previousTask"><i class="far fa-chevron-left"
                  style="font-size:1.35rem"></i></el-button>
              <el-button class="bg-secondary elBtn text-light"><span style="font-size:1.35rem"><span>{{ action }}</span>
                  {{ currentTaskSlide + 1 }} of
                  {{ dynamicObj.length }}</span></el-button>
              <el-button class="mh-orange elBtn text-light" @click.prevent="nextTask"><i class="far fa-chevron-right"
                  style="font-size:1.35rem"></i></el-button>
            </div>
          </template>
        </el-dialog>
        <div class="row pb-4">
          <div class="col-4 py-2">
            <div class="w-100 d-flex">
              ...
              <div class="w-100" v-if="currentTab == 'tasks'">
                <el-input type="search" placeholder="Enter Tasks Search Criteria" v-model="search_tasks">
                  <el-button slot="prepend" icon="el-icon-search"></el-button>
                </el-input>
              </div>
              <div class="w-100" v-if="currentTab == 'issues'">
                <el-input type="search" placeholder="Enter Issues Search Criteria" v-model="search_issues">
                  <el-button slot="prepend" icon="el-icon-search"></el-button>
                </el-input>
              </div>
              <div class="w-100" v-if="currentTab == 'risks'">
                <el-input type="search" placeholder="Enter Risks Search Criteria" v-model="search_risks">
                  <el-button slot="prepend" icon="el-icon-search"></el-button>
                </el-input>
              </div>
              <div class="w-100" v-if="currentTab == 'lessons'">
                <el-input type="search" placeholder="Enter Lessons Search Criteria" v-model="search_lessons">
                  <el-button slot="prepend" icon="el-icon-search"></el-button>
                </el-input>
              </div>
            </div>
          ...
          <div class="col-4 py-2">
            <div class="d-flex w-100">
              ...
              <template>
                <treeselect placeholder="Search and select" :multiple="true" @input="updateProgramFilterValue"
                  :value="C_portfolioNamesFilter" :options="portfolioPrograms" v-model="C_portfolioNamesFilter"
                  track-by="name" :limit="3" :maxHeight="200" :limitText="(count) => `...`" valueFormat="object" />
          ...
          <div class="col-4 pl-0 py-2">
            <div class="d-flex w-100">
              ...
              <template>
                <el-select v-model="C_categoryNameFilter" class="w-75" track-by="name" value-key="id" multiple clearable
                  @clear="setValueNull" placeholder="Select Process Area">
                  <el-option v-for="item in C_categories" :value="item" :key="item" :label="item">
                  </el-option>
                </el-select>
              </template>
            </div>
        ...
        <el-tabs class="mt-1" type="border-card" @tab-click="handleClick" style="postion:relative">
          <!-- TASKS -->
          <el-tab-pane class="pt-2" name="tasks" style="postion:relative" v-loading="!portfolioTasksLoaded"
            element-loading-text="Fetching Portfolio Tasks. Please wait..." element-loading-spinner="el-icon-loading"
            element-loading-background="rgba(0, 0, 0, 0.8)">
            <template slot="label" class="text-right" v-if="true">
              TASKS
              <span class="badge badge-secondary badge-pill" v-if="portfolioCounts.responseHash">
                <span>{{ portfolioCounts.responseHash.tasksCount }}</span>
              </span>
            </template>
              ...
              <div class="row py-1 pr-2">
                <div class="col-10 px-1 pt-2">
                  <div class="pb-0 pl-2 pr-4 mb-0 d-inline-flex">
                    <span class=""><label class="font-sm px-2 mt-4 d-block">STATES TO DISPLAY</label>
                    </span>

                    <span class="d-flex statesCol mr-3 px-3 py-2">
                      <div class="pr-4 text-center icons" :class="[hideCompleteFlag == true ? 'light' : '']"
                        @click.prevent="toggleComplete">
                        <span class="d-block">
                          <i class="fas fa-clipboard-check" :class="[
      ...
      getShowCount == false ? 'd-none' : 'd-block',
                      ...
                      <div class="pr-4 text-center icons" :class="[hideInprogressFlag == true ? 'light' : '']"
                        @click.prevent="toggleInprogress">
                        <span class="d-block">
                          <i class="far fa-tasks" :class="[
      ...
      getShowCount == false ? 'd-none' : 'd-block',
                      ...
                      <div class="pr-4 text-center icons" :class="[hideOverdueFlag == true ? 'light' : '']"
                        @click.prevent="toggleOverdue">
                        <span class="d-block">
                          <i class="fas fa-calendar" :class="[
      ...
      getShowCount == false ? 'd-none' : 'd-block',
                      ...
                      <div class="pr-4 text-center icons" :class="[hideOngoingFlag == true ? 'light' : '']"
                        @click.prevent="toggleOngoing">
                        <span class="d-block">
                          <i class="fas fa-retweet" :class="[
      ...
      getShowCount == false ? 'd-none' : 'd-block',
                          ...
                          <span v-if="tasksObj.filtered.tasks">{{ taskVariation.ongoing.count
                      ...
                      <div class="pr-4 text-center icons" :class="[hidePlannedFlag == true ? 'light' : '']"
                        @click.prevent="togglePlanned">
                        <span class="d-block">
                          <i class="fas fa-calendar-check" :class="[
      ...
      taskVariation.planned.count
                      ...
                      <div class="pr-4 text-center icons" :class="[hideOnholdFlag == true ? 'light' : '']"
                        @click.prevent="toggleOnhold">
                        <span class="d-block">
                          <i class="fas fa-pause-circle" :class="[
      ...
      getShowCount == false ? 'd-none' : 'd-block',
                      ...
                      <div class="text-center icons" :class="[hideDraftFlag == true ? 'light' : '']"
                        @click.prevent="toggleDraft">
                        <span class="d-block">
                          <i class="fas fa-pencil-alt" :class="[
      ...
      getShowCount == false ? 'd-none' : 'd-block',
                    ...
                    <span class=""><label class="font-sm mt-4 pr-2"><b>FOCUS</b></label>
                    </span>
                    <span class="tagsCol d-flex px-3 py-2">
                      <div class="text-center icons" :class="[hideWatchedFlag == true ? '' : 'light']"
      ...
      getShowCount == false ? 'd-none' : 'd-block',
                      ...
                      <div class="px-4 text-center icons" :class="[hideImportantFlag == true ? '' : 'light']"
      ...
      getShowCount == false ? 'd-none' : 'd-block',
                      ...
                      <div class="text-center icons" :class="[hideBriefedFlag == true ? '' : 'light']"
                        @click.prevent="toggleBriefing">
                        <span class="d-block">
                          <i class="fas fa-presentation" :class="[
      ...
      getShowCount == false ? 'd-none' : 'd-block',
                  ...
                  <template>
                    <v-checkbox v-model="C_showCountToggle" class="d-inline-block portfolio" @click.prevent="showCounts"
                      :label="`Show Counts`"></v-checkbox>
                  </template>
                </div>

                <div class="col-2 pl-0 pr-2">
                  <span class="btnRow d-flex">
                    <button v-tooltip="`Presentation Mode`" @click.prevent="openTpresentation"
                      class="btn btn-md presentBtn mr-1 mh-blue text-light"
                      :disabled="tasksObj.filtered.tasks.length == 0">
                      <i class="fas fa-presentation"></i>
                    </button>
                    <button v-tooltip="`Export to PDF`" @click.prevent="exportTasksToPdf"
                      class="btn btn-md exportBtns text-light" :disabled="tasksObj.filtered.tasks.length == 0">
                      <i class="far fa-file-pdf"></i>
                    </button>
                    <button v-tooltip="`Export to Excel`" @click.prevent="
      exportTasksToExcel('table', 'Portfolio Tasks')
      " class="btn btn-md mx-1 exportBtns text-light" :disabled="tasksObj.filtered.tasks.length == 0">
                      <i class="far fa-file-excel"></i>
                    </button>
                    <button class="btn text-light btn-md mh-orange px-1 profile-btns portfolioResultsBtn">
              ...
              <div class="row mt-2 pr-3" style="postion:relative" v-if="tasksObj.filtered.tasks !== null &&
      tasksObj.filtered.tasks.length > 0
      ">
                <div class="px-3 tableFixHead">
                  <table class="table table-sm table-bordered" id="portTasks">
                    <thead style="background-color: #ededed">
                      <th class="sort-th twenty" @click="sortCol1('program_name')">
                        Program Name
                        <span class="inactive-sort-icon scroll" v-if="currentSortCol1 !== 'program_name'">
                          <i class="fas fa-sort"></i></span>
                        <span class="sort-icon main scroll" v-if="currentSortDir1 === 'asc' &&
      currentSortCol1 === 'program_name'
      ">
                          <i class="fas fa-sort-up"></i></span>
                        <span class="inactive-sort-icon scroll" v-if="currentSortDir1 !== 'asc' &&
      currentSortCol1 === 'program_name'
      ">
                          <i class="fas fa-sort-up"></i></span>
                        <span class="sort-icon main scroll" v-if="currentSortDir1 === 'desc' &&
      currentSortCol1 === 'program_name'
      ">
                          <i class="fas fa-sort-down"></i></span>
                        <span class="inactive-sort-icon scroll" v-if="currentSortDir1 !== 'desc' &&
      currentSortCol1 === 'program_name'
      ">
                          <i class="fas fa-sort-down"></i></span>
                      </th>
                      <th class="sort-th twenty" @click="sortCol2('project_name')">
                        Project Name
                        <span class="inactive-sort-icon scroll" v-if="currentSortDir2 !== ''">
                          <i class="fas fa-sort"></i></span>
                        <span class="sort-icon main scroll" v-if="currentSortDir2 === 'asc' &&
      currentSortCol2 === 'project_name'
      ">
                          <i class="fas fa-sort-up"></i></span>
                        <span class="inactive-sort-icon scroll" v-if="currentSortDir2 !== 'asc' &&
      currentSortCol2 === 'project_name'
      ">
                          <i class="fas fa-sort-up"></i></span>
                        <span class="sort-icon main scroll" v-if="currentSortDir2 === 'desc' &&
      currentSortCol2 === 'project_name'
      ">
                          <i class="fas fa-sort-down"></i></span>
                        <span class="inactive-sort-icon scroll" v-if="currentSortDir2 !== 'desc' &&
      currentSortCol2 === 'project_name'
      ">
                          <i class="fas fa-sort-down"></i></span>
                      </th>
      ...
      ">
                      ...
                      <th class="sort-th twenty" @click="sort('notes_updated_at')" style="min-width: 300px">
                        Last Update
                        <span class="inactive-sort-icon scroll" v-if="currentSort !== 'notes_updated_at'">
                          <i class="fas fa-sort"></i></span>
                        <span class="sort-icon scroll" v-if="currentSortDir === 'asc' &&
      currentSort === 'notes_updated_at'
      ">
                          <i class="fas fa-sort-up"></i></span>
                        <span class="inactive-sort-icon scroll" v-if="currentSortDir !== 'asc' &&
      currentSort === 'notes_updated_at'
      ">
                          <i class="fas fa-sort-up"></i></span>
                        <span class="sort-icon scroll" v-if="currentSortDir === 'desc' &&
      currentSort === 'notes_updated_at'
      ">
                          <i class="fas fa-sort-down"></i></span>
                        <span class="inactive-sort-icon scroll" v-if="currentSortDir !== 'desc' &&
      currentSort === 'notes_updated_at'
      ">
                          <i class="fas fa-sort-down"></i></span>
                      </th>

                      <th class="sort-th" style="min-width: 140px" @click="sort('start_date')">
                        Start Date
      ...
      ">
                      ...
                      <th class="sort-th" style="min-width: 140px" @click="sort('due_date')">
                        Due Date
      ...
      ">
                      ...
                      <th class="sort-th" style="min-width: 115px" @click="sort('progress')">
                        Progress
      ...
      ">
                    ...
                    <tbody>
                      <tr v-for="(task, index) in sortedTasks.reverse()" :key="index" class="portTable taskHover"
                        @click="openTask(task)">
                        <td>{{ task.program_name }}</td>
                        <td>{{ task.project_name }}</td>
                        <td>{{ task.text }}</td>
                        <td v-if="task.notes_updated_at.length > 0">
                          <span class="toolTip" v-tooltip="'By: ' +
      ...
      moment(task.start_date).format("DD MMM YYYY")
                        ...
                        <td class="text-center">
                          <span v-if="task.ongoing && !task.closed" v-tooltip="`Ongoing`"><i
                              class="fas fa-retweet text-success"></i></span>
                          <span v-else-if="task.completed &&
      (task.due_date == null ||
        task.due_date == undefined)
      "></span>
                          <span v-else-if="task.on_hold && task.due_date == null"
                            v-tooltip="`On Hold (w/no Due Date)`"><i
                              class="fas fa-pause-circle text-primary"></i></span>
                          <span v-else>{{
      moment(task.due_date).format("DD MMM YYYY")
                        ...
                        <td class="text-center">
                          <span v-if="task.ongoing && !task.closed" v-tooltip="`Ongoing`"><i
                              class="fas fa-retweet text-success"></i></span>
                          <span v-else-if="task.closed" v-tooltip="`Ongoing: Closed`"><i
                              class="fas fa-retweet text-secondary"></i></span>
                        ...
                        <td class="text-center">
                          <span v-if="task.is_overdue" v-tooltip="`Overdue`">
                            <i class="fas fa-calendar text-danger mr-1"></i></span>
                          <span v-if="task.completed" v-tooltip="`Completed`"><i
                              class="fas fa-clipboard-check text-success mr-1"></i></span>
                          <span v-if="task.ongoing == true && !task.closed" v-tooltip="`Ongoing`"><i
                              class="fas fa-retweet mr-1 text-success"></i></span>
                          <span v-if="task.closed" v-tooltip="`Ongoing: Closed`"><i
                              class="fas fa-retweet mr-1 text-secondary"></i></span>
                          <span v-if="task.on_hold == true" v-tooltip="`On Hold`">
                            <i class="fas fa-pause-circle mr-1 text-primary"></i></span>
                          <span v-if="task.draft == true" v-tooltip="`Draft`">
                            <i class="fas fa-pencil-alt mr-1 text-warning"></i></span>
                          <span v-if="task.watched == true" v-tooltip="`On Watch`"><i
                              class="fas fa-eye mr-1"></i></span>
                          <span v-if="task.important == true" v-tooltip="`Important`">
                            <i class="fas fa-star text-warning mr-1"></i></span>
                          <span v-if="task.reportable" v-tooltip="`Briefings`">
                            <i class="fas fa-presentation mr-1 text-primary"></i></span>
                          <span v-if="task.planned" v-tooltip="`Planned`">
                            <i class="fas fa-calendar-check text-info mr-1"></i></span>
                          <span v-if="task.in_progress" v-tooltip="`In Progress`">
                            <i class="far fa-tasks text-primary mr-1"></i></span>
                  ...
                  <!-- EXPORT (Display:None) -->
                  <table class="table table-bordered w-100" ref="table" id="portTasks1" style="display:none">
                    <thead>
      ...
      moment(task.due_date).format("DD MMM YYYY")
                        ...
                        <td class="text-center">
                          ...
                          <span v-if="task.ongoing == true && !task.closed" v-tooltip="`Ongoing`">Ongoing</span>
                          <span v-if="task.closed" v-tooltip="`Ongoing: Closed`">Ongoing</span>
                          <span v-if="task.on_hold == true" v-tooltip="`On Hold`">
                            On Hold
                          </span>
                          <span v-if="task.draft == true" v-tooltip="`Draft`">
        ...
        "DD MMM YYYY, h:mm a"
                ...
                <div class="ml-auto mb-4 mt-2 font-sm">
                  <div class="simple-select d-inline-block text-right font-sm">
                    ...
                    <el-select v-model="C_tasksPerPage" class="w-33" track-by="value" value-key="id">
                      <el-option v-for="item in getTasksPerPageFilterOptions" :value="item" :key="item.id"
                        :label="item.name">
                      </el-option>
                    </el-select>
                  </div>
                  <span class="mr-1 pr-3" style="border-right: solid 1px lightgray">Per Page
                  </span>
      ...
      Math.ceil(
        ...
        this.C_tasksPerPage.value
          ...
          <el-tab-pane class="pt-2" name="issues" v-loading="!portfolioIssuesLoaded"
            element-loading-text="Fetching Portfolio Issues. Please wait..." element-loading-spinner="el-icon-loading"
            element-loading-background="rgba(0, 0, 0, 0.8)">
            <template slot="label" class="text-right">
              ISSUES
              <span v-if="portfolioCounts.responseHash" class="badge badge-secondary badge-pill">
                <span>{{ portfolioCounts.responseHash.issuesCount }}</span>
              </span>
            </template>
      ...
      getShowCount == false ? 'd-none' : 'd-block',
                  ...
                  <template>
                    <v-checkbox v-model="C_showCountToggle" class="d-inline-block  portfolio"
                      @click.prevent="showCounts" :label="`Show Counts`"></v-checkbox>
                  </template>
                </div>

                <div class="col-2 pl-0 pr-2">
                  <span class="btnRow d-flex">
                    <button v-tooltip="`Presentation Mode`" @click.prevent="openIpresentation"
                      class="btn btn-md presentBtn mr-1 text-light mh-blue"
                      :disabled="issuesObj.filtered.issues.length == 0">
                      <i class="fas fa-presentation"></i>
                    </button>
                    <button v-tooltip="`Export to PDF`" @click.prevent="exportIssuesToPdf"
                      class="btn btn-md exportBtns text-light" :disabled="issuesObj.filtered.issues.length == 0">
                      <i class="far fa-file-pdf"></i>
                    </button>
                    <button v-tooltip="`Export to Excel`" @click.prevent="
      exportIssuesToExcel('table', 'Portfolio Issues')
      " class="btn btn-md mx-1 exportBtns text-light" :disabled="issuesObj.filtered.issues.length == 0">
                      <i class="far fa-file-excel"></i>
                    </button>
                    <button class="btn text-light btn-md mh-orange px-1 profile-btns portfolioResultsBtn">
            ...
            <div class="row mt-1 pr-3" v-if="issuesObj.filtered.issues !== null &&
      issuesObj.filtered.issues.length > 0
      ">
              <div class="px-3 tableFixHead" style="overflow-x: auto">
                <table class="table table-sm table-bordered" id="portIssues">
                  <thead style="background-color: #ededed">
                    <th class="sort-th twenty" @click="sortCol1('program_name')">
                      Program Name
                      <span class="inactive-sort-icon scroll" v-if="currentSortCol1 !== 'program_name'">
      ...
      ">
                    ...
                    <th class="sort-th twenty" @click="sortCol2('project_name')">
                      Project Name
                      <span class="inactive-sort-icon scroll" v-if="currentSortCol2 !== ''">
                        <i class="fas fa-sort"></i></span>
                      <span class="sort-icon main scroll" v-if="currentSortDir2 === 'asc' &&
      currentSortCol2 === 'project_name'
      ">
      ...
      ">
                    ...
                    <th class="sort-th" style="min-width: 300px" @click="sortI('notes_updated_at')">
                      Last Update
                      <span class="inactive-sort-icon scroll" v-if="currentSort !== 'notes_updated_at'">
                        <i class="fas fa-sort"></i></span>
                      <span class="sort-icon scroll" v-if="currentSortDir === 'asc' &&
      ...
      ">
                    ...
                    <th class="sort-th" style="min-width: 115px" @click="sortI('progress')">
                      Progress
                      <span class="inactive-sort-icon scroll" v-if="currentSort !== 'progress'">
                        <i class="fas fa-sort"></i></span>
      ...
      ">
                  ...
                  <tbody>
                    <tr v-for="(issue, index) in sortedIssues" :key="index" class="portTable taskHover"
                      ...
                      <td>{{ issue.title }}</td>
                      <!-- <td v-if="issue.notes_updated_at.length > 0">
                        <span class="toolTip" v-tooltip="'By: ' +
      ...
      moment(issue.notes_updated_at[0]).format(
        "DD MMM YYYY, h:mm a"
                      ...
                      <td class="text-center">
                        <span v-if="issue.on_hold && issue.due_date == null" v-tooltip="`On Hold (w/no Due Date)`"><i
                            class="fas fa-pause-circle text-primary"></i></span>
                        <span v-else-if="issue.completed &&
      (issue.due_date == null ||
        issue.due_date == undefined)
      "></span>
                        <span v-else>{{ moment(issue.due_date).format("DD MMM YYYY") }}
                        </span>
                      </td>
                      <td>{{ issue.users }}</td>
                      ...
                      <td class="text-center">
                        ...
                        <span v-if="issue.completed" v-tooltip="`Completed`"><i
                            class="fas fa-clipboard-check text-success mr-1"></i></span>
                        <span v-if="issue.on_hold == true" v-tooltip="`On Hold`">
                          <i class="fas fa-pause-circle mr-1 text-primary"></i></span>
                        <span v-if="issue.draft == true" v-tooltip="`Draft`">
                          <i class="fas fa-pencil-alt text-warning"></i></span>
                        <span v-if="issue.watched == true" v-tooltip="`On Watch`"><i class="fas fa-eye mr-1"></i></span>
                        <span v-if="issue.important == true" v-tooltip="`Important`">
                          <i class="fas fa-star text-warning mr-1"></i></span>
                        <span v-if="issue.reportable" v-tooltip="`Briefings`">
                          <i class="fas fa-presentation mr-1 text-primary"></i></span>
                        <span v-if="issue.planned" v-tooltip="`Planned`">
                          <i class="fas fa-calendar-check text-info mr-1"></i></span>
                        <span v-if="issue.in_progress" v-tooltip="`In Progress`">
                          <i class="far fa-tasks text-primary mr-1"></i></span>
                      </td>
                ...
                <table class="table table-bordered w-100" ref="issueTable" id="portIssues1" style="display:none">
                  <thead>
                    <tr style="background-color:#ededed">
                      <th>Issue</th>
                      <th>Issue Type</th>
      ...
      "></span>
                      ...
                      <!-- <td>
                        <span v-if="issue.notes_updated_at.length > 0">
                          <span class="toolTip" v-tooltip="'By: ' +
      ...
      moment(issue.notes_updated_at[0]).format(
        "DD MMM YYYY, h:mm a"
              ...
              <div class="ml-auto mb-4 mt-2 font-sm">
                <div class="simple-select d-inline-block text-right font-sm">
                  <span class="mr-1">Displaying </span>
                  <el-select v-model="C_issuesPerPage" class="w-33" track-by="value" value-key="id">
                    <el-option v-for="item in getIssuesPerPageFilterOptions" :value="item" :key="item.id"
                      :label="item.name">
                    </el-option>
                  </el-select>
                </div>
      ...
      Math.ceil(
        ...
        this.C_issuesPerPage.value
          ...
          <el-tab-pane class="pt-2" name="risks" v-loading="!portfolioRisksLoaded"
            element-loading-text="Fetching Portfolio Risks. Please wait..." element-loading-spinner="el-icon-loading"
            element-loading-background="rgba(0, 0, 0, 0.8)">
            <template slot="label" class="text-right" v-if="risksObj.filtered.risks && risksObj.filtered.risks !== undefined
      ">
              RISKS
              <span v-if="portfolioCounts.responseHash" class="badge badge-secondary badge-pill">
                <span>{{ portfolioCounts.responseHash.risksCount }}</span>
              </span>
            </template>
      ...
      getShowCount == false ? 'd-none' : 'd-block',
                          ...
                          <span v-if="risksObj.filtered.risks">{{ riskVariation.ongoing.count
      ...
      getShowCount == false ? 'd-none' : 'd-block',
                ...
                <div class="col-2 pl-0 pr-2">
                  <span class="btnRow d-flex">
                    <button v-tooltip="`Presentation Mode`" @click.prevent="openRpresentation"
                      class="btn btn-md mr-1 text-light mh-blue presentBtn"
                      :disabled="risksObj.filtered.risks.length == 0">
                      <i class="fas fa-presentation"></i>
                    </button>
                    <button v-tooltip="`Export to PDF`" @click.prevent="exportRisksToPdf"
                      class="btn btn-md exportBtns text-light" :disabled="risksObj.filtered.risks.length == 0">
                      <i class="far fa-file-pdf"></i>
                    </button>
                    <button v-tooltip="`Export to Excel`" @click.prevent="
      exportRisksToExcel('table', 'Portfolio Risks')
      " class="btn btn-md mx-1 exportBtns text-light" :disabled="risksObj.filtered.risks.length == 0">
                      <i class="far fa-file-excel"></i>
                    </button>
                    <button class="btn text-light btn-md mh-orange px-1 profile-btns portfolioResultsBtn">
              ...
              <div class="row mt-2 pr-3" v-if="risksObj.filtered.risks !== null &&
      risksObj.filtered.risks.length > 0
      ">
                <div class="px-3 tableFixHead">
                  <table class="table table-sm table-bordered" id="portRisks">
                    <thead style="background-color: #ededed">
                      <th class="sort-th twenty" @click="sortCol1('program_name')">
                        Program Name
                        <span class="inactive-sort-icon scroll" v-if="currentSortCol1 !== 'program_name'">
      ...
      ">
                      ...
                      <th class="sort-th" style="min-width: 300px" @click="sort('notes_updated_at')">
                        Last Update
                        <span class="inactive-sort-icon scroll" v-if="currentSort !== 'notes_updated_at'">
                          <i class="fas fa-sort"></i></span>
                        <span class="sort-icon scroll" v-if="currentSortDir === 'asc' &&
      ...
      ">
                      ...
                      <th class="sort-th" @click="sort('due_date')" style="min-width: 145px">
      ...
      ">
                    ...
                    <tbody>
                      <tr v-for="(risk, index) in sortedRisks" :key="index" class="portTable taskHover"
                        ...
                        <td>{{ risk.text }}</td>
                        <td v-if="risk.notes_updated_at.length > 0">
                          <span class="toolTip" v-tooltip="'By: ' +
      ...
      moment(risk.start_date).format("DD MMM YYYY")
                        ...
                        <td class="text-center">
                          <span v-if="risk.ongoing && !risk.closed" v-tooltip="`Ongoing`"><i
                              class="fas fa-retweet text-success"></i></span>
                          <span v-else-if="risk.completed &&
      (risk.due_date == null ||
        risk.due_date == undefined)
      "></span>
                          <span v-else-if="risk.on_hold && risk.due_date == null"
                            v-tooltip="`On Hold (w/no Due Date)`"><i
                              class="fas fa-pause-circle text-primary"></i></span>
                          <span v-else>{{
      moment(risk.due_date).format("DD MMM YYYY")
                        ...
                        <td class="text-center">
                          <span v-if="risk.ongoing && !risk.closed" v-tooltip="`Ongoing`"><i
                              class="fas fa-retweet text-success"></i></span>
                          <span v-else-if="risk.closed" v-tooltip="`Ongoing: Closed`"><i
                              class="fas fa-retweet text-secondary"></i></span>
                          <span v-else>
                            {{ risk.progress + "%" }}
                          </span>
                        ...
                        <td class="text-center">
                          <span v-if="risk.is_overdue" v-tooltip="`Overdue`"><i
                              class="fas fa-calendar mr-1 text-danger"></i></span>
                          <span v-if="risk.completed" v-tooltip="`Completed`"><i
                              class="fas fa-clipboard-check mr-1 text-success"></i></span>
                          <span v-if="risk.ongoing == true && !risk.closed" v-tooltip="`Ongoing`"><i
                              class="fas fa-retweet text-success"></i></span>
                          <span v-if="risk.closed == true" v-tooltip="`Ongoing: Closed`"><i
                              class="fas fa-retweet text-secondary"></i></span>
                          <span v-if="risk.on_hold == true" v-tooltip="`On Hold`">
                            <i class="fas fa-pause-circle mr-1 text-primary"></i></span>
                          <span v-if="risk.draft == true" v-tooltip="`Draft`">
                            <i class="fas fa-pencil-alt text-warning"></i></span>
                          <span v-if="risk.watched == true" v-tooltip="`On Watch`"><i
                              class="fas fa-eye mr-1"></i></span>
                          <span v-if="risk.important == true" v-tooltip="`Important`">
                            <i class="fas fa-star text-warning mr-1"></i></span>
                          <span v-if="risk.reportable" v-tooltip="`Briefings`">
                            <i class="fas fa-presentation mr-1 text-primary"></i></span>
                          <span v-if="risk.planned" v-tooltip="`Planned`">
                            <i class="fas fa-calendar-check text-info mr-1"></i></span>
                          <span v-if="risk.in_progress" v-tooltip="`In Progress`">
                            <i class="far fa-tasks text-primary mr-1"></i></span>
                        </td>
                        <td>{{ risk.category }}</td>
                  ...
                  <!-- Export (Display:none) -->
                  <table class="table table-bordered w-100" ref="riskTable" id="portRisks1" style="display:none">
                    <thead>
                      <tr style="background-color:#ededed">
                        <th>Risk</th>
                        <th>Project</th>
      ...
      moment(risk.due_date).format("DD MMM YYYY")
                        ...
                        <td class="text-center">
                          ...
                          <span v-if="risk.ongoing == true && !risk.closed" v-tooltip="`Ongoing`">
                            Ongoing
                          </span>
                          <span v-if="risk.closed == true" v-tooltip="`Ongoing: Closed`">
                            Ongoing
                          </span>
                          <span v-if="risk.on_hold == true" v-tooltip="`On Hold`">
                            On Hold
      ...
      moment(risk.notes_updated_at[0]).format(
        "DD MMM YYYY, h:mm a"
                ...
                <div class="ml-auto mb-4 mt-2 font-sm">
                  <div class="simple-select d-inline-block text-right font-sm">
                    <span class="mr-1">Displaying </span>
                    <el-select v-model="C_risksPerPage" class="w-33" track-by="value" value-key="id">
                      <el-option v-for="item in getRisksPerPageFilterOptions" :value="item" :key="item.id"
                        :label="item.name">
                      </el-option>
                    </el-select>
                  </div>
      ...
      Math.ceil(
        ...
        this.C_risksPerPage.value
          ...
          <el-tab-pane class="pt-2" name="lessons" v-loading="!portfolioLessonsLoaded"
            element-loading-text="Fetching Portfolio Lessons. Please wait..." element-loading-spinner="el-icon-loading"
            element-loading-background="rgba(0, 0, 0, 0.8)">
            <template slot="label" class="text-right">
              LESSONS LEARNED
              <span v-if="portfolioCounts.responseHash" class="badge badge-secondary badge-pill">
                {{ portfolioCounts.responseHash.lessonsCount }}
              </span>
            </template>
            <div class="box-shadow py-2">
              <div class="row py-1 pr-2">
      ...
      getShowCount == false ? 'd-none' : 'd-block',
                    ...
                    <span class="tagsCol d-flex px-3 py-2">
                      <div class="pr-4 text-center icons" :class="[hideImportantFlag == true ? '' : 'light']"
                        @click.prevent="toggleImportant">
                        <span class="d-block">
                          <i class="fas fa-star" :class="[
      hideImportantFlag == true
      ...
      getShowCount == false ? 'd-none' : 'd-block',
                ...
                <div class="col-2 pl-0 pr-2">
                  <span class="btnRow d-flex">
                    <button v-tooltip="`Presentation Mode`" @click.prevent="openLpresentation"
                      class="btn btn-md presentBtn mr-1 mh-blue" :disabled="lessonsObj.filtered.lessons.length == 0">
                      <i class="fas fa-presentation text-light"></i>
                    </button>
                    <button v-tooltip="`Export to PDF`" @click.prevent="exportLessonsToPdf"
                      class="btn btn-md exportBtns text-light" :disabled="lessonsObj.filtered.lessons.length == 0">
                      <i class="far fa-file-pdf"></i>
                    </button>
                    <button v-tooltip="`Export to Excel`" @click.prevent="
      exportLessonsToExcel('table', 'Portfolio Lessons')
      " class="btn btn-md mx-1 exportBtns text-light" :disabled="lessonsObj.filtered.lessons.length == 0">
                      <i class="far fa-file-excel"></i>
                    </button>
                    <button class="btn text-light btn-md mh-orange px-1 profile-btns portfolioResultsBtn">
              ...
              <div class="row mt-2 pr-3" v-if="lessonsObj.filtered.lessons !== null &&
      lessonsObj.filtered.lessons.length > 0
      ">
                <div class="tableFixHead px-3">
                  <table class="table table-sm table-bordered" id="portLessons">
                    <thead style="background-color: #ededed">
                      <th class="sort-th twenty" @click="sortCol1('program_name')">
                        Program Name
      ...
      ">
                      ...
                      <th class="pl-1 sort-th" style="min-width: 325px" @click="sortL('description')">
                        Description
      ...
      ">
                      ...
                      <th class="sort-th" @click="sortL('created_at')" style="min-width: 140px">
                        Date Added
      ...
      ">
                    ...
                    <tbody>
                      <tr v-for="(lesson, index) in sortedLessons" :key="index" class="portTable taskHover"
                        ...
                        <td>{{ lesson.title }}</td>
                        <td v-if="lesson.notes_updated_at.length > 0">
                          <span class="toolTip" v-tooltip="'By: ' +
      ...
      lesson.description
                        ...
                        <td class="text-center">
                          <span v-if="lesson.draft == true" v-tooltip="`Draft`">
                            <i class="fas fa-pencil-alt text-warning"></i></span>
                          <span v-if="lesson.draft == false" v-tooltip="`Completed`">
                            <i class="fas fa-clipboard-check text-success"></i></span>
                          <span v-if="lesson.important == true" v-tooltip="`Important`">
                            <i class="fas fa-star text-warning mr-1"></i></span>
                          <span v-if="lesson.reportable" v-tooltip="`Briefings`">
                            <i class="fas fa-presentation mr-1 text-primary"></i></span>

                          <span v-if="lesson.important == false &&
      ...
      lesson.category
                  ...
                  <table class="table table-bordered w-100" id="portLessons1" style="display:none" ref="lessonTable">
                    <thead>
                      <tr style="background-color:#ededed">
                        <th>Lesson</th>
                        <th>Date Added</th>
                    ...
                    <tbody v-for="(p, i) in validLessonPrograms" :key="i">
                      ...
                      <tr v-for="(lesson, index) in lessonsObj.filtered.lessons" :key="index"
                ...
                <div class="ml-auto mb-4 mt-2 font-sm">
                  <div class="simple-select d-inline-block text-right font-sm">
                    ...
                    <el-select v-model="C_lessonsPerPage" class="w-33" track-by="value" value-key="id">
                      <el-option v-for="item in getLessonsPerPageFilterOptions" :value="item" :key="item.id"
                        :label="item.name">
                      </el-option>
                    </el-select>
                  </div>
    ...
    portfolioTasksLoaded: {
      handler() {
        if (this.portfolioTasksLoaded) {
          this.taskArray = this.portfolioTasks.responseHash.tasks;
          this.dynamicArray = this.portfolioTasks.responseHash.tasks;
          // this.taskLastPage = this.portfolioTasks.last_page;
          this.taskCount = this.portfolioTasks.responseHash.totalCount;
          let currCount = this.portfolioTasks.responseHash.tasks.length;
          let total = this.portfolioTasks.responseHash.totalCount;
    ...
    portfolioIssuesLoaded: {
      handler() {
        if (this.portfolioIssuesLoaded) {
          this.issueArray = this.portfolioIssues.responseHash.issues;
          this.dynamicArray = this.portfolioIssues.responseHash.issues;
          // this.issueLastPage = this.portfolioIssues.last_page;
          this.issueCount = this.portfolioIssues.responseHash.totalCount;
          let currCount = this.portfolioIssues.responseHash.issues.length;
          let total = this.portfolioIssues.responseHash.totalCount;
          if (this.portfolioIssues.responseHash.nextPage && this.portfolioIssues.responseHash.currentPage != this.portfolioIssues.responseHash.nextPage) {
            let page = this.portfolioIssues.responseHash.nextPage
            this.fetchPortfolioIssues({ page });
          }
    ...
    portfolioRisksLoaded: {
      handler() {
        if (this.portfolioRisksLoaded) {
          this.riskArray = this.portfolioRisks.responseHash.risks;
          this.dynamicArray = this.portfolioRisks.responseHash.risks;
          // this.riskLastPage = this.portfolioRisks.last_page;
          this.riskCount = this.portfolioRisks.responseHash.totalCount;
          let currCount = this.portfolioRisks.responseHash.risks.length;
          let total = this.portfolioRisks.responseHash.totalCount;
          if (this.portfolioRisks.responseHash.nextPage && this.portfolioRisks.responseHash.currentPage != this.portfolioRisks.nextPage) {
            let page = this.portfolioRisks.responseHash.nextPage
            this.fetchPortfolioRisks({ page });
          }
          // if (currCount < total) {
          //   let size = (this.loadMoreItems += 250);
    ...
    portfolioLessonsLoaded: {
      handler() {
        if (this.portfolioLessonsLoaded) {
          this.lessonArray = this.portfolioLessons.responseHash.lessons;
          this.dynamicArray = this.portfolioLessons.responseHash.lessons;
          // this.lessonLastPage = this.portfolioLessons.responseHash.last_page;
          this.lessonCount = this.portfolioLessons.responseHash.totalCount;
          let currCount = this.portfolioLessons.responseHash.lessons.length;
          let total = this.portfolioLessons.responseHash.totalCount;
          if (this.portfolioLessons.responseHash.nextPage && this.portfolioLessons.responseHash.currentPage != this.portfolioLessons.nextPage) {
            let page = this.portfolioLessons.responseHash.nextPage
            this.fetchPortfolioLessons({ page });
          }
          // if (currCount < total) {
          //   let size = (this.loadMoreItems += 250);
