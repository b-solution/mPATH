...
const portfolioModule = {
  ...
  mutations: {
    setPortfolioWatchedTasksToggle: (state, showAll) =>
      (state.portfolioWatchedTasksToggle = showAll),
    setPortfolioImportantTasksToggle: (state, showAll) =>
      (state.portfolioImportantTasksToggle = showAll),
    setPortfolioBriefedTasksToggle: (state, showAll) =>
      (state.portfolioBriefedTasksToggle = showAll),
    ...
    SET_PORTFOLIO_PROGRAMS_FILTER: (state, portfolio_programs_filter) =>
      (state.portfolio_programs_filter = portfolio_programs_filter),
    TOGGLE_PORTFOLIO_PROGRAMS_FILTER_LOADED: (state, loaded) =>
      (state.portfolio_programs_filter_loaded = loaded),

    SET_AUTHORIZED_PORTFOLIO_PROGRAMS: (state, authorized_portfolio_programs) =>
      (state.authorized_portfolio_programs = authorized_portfolio_programs),
    TOGGLE_AUTHORIZED_PORTFOLIO_PROGRAMS_LOADED: (state, loaded) =>
      (state.authorized_portfolio_programs_loaded = loaded),
    ...
    SET_PORTFOLIO_PROGRAMS: (state, portfolio_programs) =>
      (state.portfolio_programs = portfolio_programs),
    ...
    setPortfolioUsersFilter: (state, portfolioUsersFilter) =>
      (state.portfolioUsersFilter = portfolioUsersFilter),

    // PORTFOLIO PROJECT STATUSES
    SET_PORTFOLIO_STATUSES: (state, portfolio_statuses) =>
      (state.portfolio_statuses = portfolio_statuses),
    TOGGLE_PORTFOLIO_STATUSES_LOADED: (state, loaded) => (state.portfolio_statuses_loaded = loaded),
    setPortfolioStatusesFilter: (state, portfolioStatusesFilter) =>
      (state.portfolioStatusesFilter = portfolioStatusesFilter),

    // PORTFOLIO STAGES (TASKS, ISSUES, RISKS)
    SET_PORTFOLIO_TASK_STAGES: (state, portfolio_task_stages) =>
      (state.portfolio_task_stages = portfolio_task_stages),
    TOGGLE_PORTFOLIO_TASK_STAGES_LOADED: (state, loaded) =>
      (state.portfolio_task_stages_loaded = loaded),
    setPortfolioTaskStagesFilter: (state, portfolioTaskStagesFilter) =>
      (state.portfolioTaskStagesFilter = portfolioTaskStagesFilter),

    SET_PORTFOLIO_ISSUE_STAGES: (state, portfolio_issue_stages) =>
      (state.portfolio_issue_stages = portfolio_issue_stages),
    TOGGLE_PORTFOLIO_ISSUE_STAGES_LOADED: (state, loaded) =>
      (state.portfolio_issue_stages_loaded = loaded),
    setPortfolioIssueStagesFilter: (state, portfolioIssueStagesFilter) =>
      (state.portfolioIssueStagesFilter = portfolioIssueStagesFilter),

    //PORTFOLIO RISKS
    SET_PORTFOLIO_RISK_APPROACHES: (state, portfolio_risk_approaches) =>
      (state.portfolio_risk_approaches = portfolio_risk_approaches),
    TOGGLE_PORTFOLIO_RISK_APPROACHES_LOADED: (state, loaded) =>
      (state.portfolio_risk_approaches_loaded = loaded),
    setPortfolioRiskApproachesFilter: (state, portfolioRiskApproachesFilter) =>
      (state.portfolioRiskApproachesFilter = portfolioRiskApproachesFilter),

    SET_PORTFOLIO_RISK_PRIORITIES: (state, portfolio_risk_priorities) =>
      (state.portfolio_risk_priorities = portfolio_risk_priorities),
    TOGGLE_PORTFOLIO_RISK_PRIORITIES_LOADED: (state, loaded) =>
      (state.portfolio_risk_priorities_loaded = loaded),
    setPortfolioRiskPrioritiesFilter: (state, portfolioRiskPrioritiesFilter) =>
      (state.portfolioRiskPrioritiesFilter = portfolioRiskPrioritiesFilter),

    SET_PORTFOLIO_RISK_STAGES: (state, portfolio_risk_stages) =>
      (state.portfolio_risk_stages = portfolio_risk_stages),
    TOGGLE_PORTFOLIO_RISK_STAGES_LOADED: (state, loaded) =>
      (state.portfolio_risk_stages_loaded = loaded),
    setPortfolioRiskStagesFilter: (state, portfolioRiskStagesFilter) =>
      (state.portfolioRiskStagesFilter = portfolioRiskStagesFilter),

    SET_PORTFOLIO_LESSON_STAGES: (state, portfolio_lesson_stages) =>
      (state.portfolio_lesson_stages = portfolio_lesson_stages),
    TOGGLE_PORTFOLIO_LESSON_STAGES_LOADED: (state, loaded) =>
      (state.portfolio_lesson_stages_loaded = loaded),
    TOGGLE_PORTFOLIO_LESSON_LOADED: (state, loaded) => (state.portfolio_lesson_loaded = loaded),
    setPortfolioLessonStagesFilter: (state, portfolioLessonStagesFilter) =>
      (state.portfolioLessonStagesFilter = portfolioLessonStagesFilter),

    SET_PORTFOLIO_CATEGORIES: (state, portfolio_categories) =>
      (state.portfolio_categories = portfolio_categories),
    TOGGLE_PORTFOLIO_CATEGORIES_LOADED: (state, loaded) =>
      (state.portfolio_categories_loaded = loaded),
    ...
    SET_PORTFOLIO_ISSUE_TYPES: (state, portfolio_issue_types) =>
      (state.portfolio_issue_types = portfolio_issue_types),
    TOGGLE_PORTFOLIO_ISSUE_TYPES_LOADED: (state, loaded) =>
      (state.portfolio_issue_types_loaded = loaded),
    setPortfolioIssueTypesFilter: (state, portfolioIssueTypesFilter) =>
      (state.portfolioIssueTypesFilter = portfolioIssueTypesFilter),

    SET_PORTFOLIO_ISSUE_SEVERITIES: (state, portfolio_issue_severities) =>
      (state.portfolio_issue_severities = portfolio_issue_severities),
    TOGGLE_PORTFOLIO_ISSUE_SEVERITIES_LOADED: (state, loaded) =>
      (state.portfolio_issue_severities_loaded = loaded),
    setPortfolioIssueSeveritiesFilter: (state, portfolioIssueSeveritiesFilter) =>
      (state.portfolioIssueSeveritiesFilter = portfolioIssueSeveritiesFilter),
    ...
    SET_PORTFOLIO_LESSONS: (state, portfolio_lessons) =>
      (state.portfolio_lessons = portfolio_lessons),
