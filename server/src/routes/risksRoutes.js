...
const { update, show, create, create_duplicate, create_bulk_duplicate, batch_update } = require("../controllers/RisksController");
...
async function routes(fastify, options) {
  ...
  fastify.post("/api/v1/programs/:program_id/projects/:project_id/risks/:id", create_duplicate);
  fastify.post("/api/v1/programs/:program_id/projects/:project_id/risks/:id/create_bulk_duplicate", create_bulk_duplicate);
  fastify.post("/api/v1/programs/:program_id/projects/:project_id/risks/batch_update", batch_update);
}
